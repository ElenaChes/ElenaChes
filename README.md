...
- [<img height="15px;" src="https://skillicons.dev/icons?i=swift">](## "iOS App") Custom iOS app to help teach reading to children and adults with special needs and communication difficulties.<br>The repo will be shared if the app is made open source. <sub>[ `App` | [<img style="height:15px;width:15px;" src="https://cdn.simpleicons.org/swift/ffffff">](## "Swift") | [<img style="height:15px;width:15px;" src="https://cdn.simpleicons.org/xcode/ffffff">](## "xCode") ]</sub>
